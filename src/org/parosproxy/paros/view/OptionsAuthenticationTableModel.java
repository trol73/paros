...
public class OptionsAuthenticationTableModel extends AbstractTableModel {
    ...
    private List<HostAuthentication> listAuth = new ArrayList<HostAuthentication>();
...
//        Object result = null;
     ...
     */
    public Vector<HostAuthentication> getListAuth() {	// TODO LIST
    ...
    public void setListAuth(List<HostAuthentication> listAuth) {
        this.listAuth = new ArrayList<HostAuthentication>(listAuth);
        checkAndAppendNewRow();
