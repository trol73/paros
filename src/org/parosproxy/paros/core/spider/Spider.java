...
//    private boolean isSubmitForm;
    private List<SpiderListener> listenerList = new ArrayList<SpiderListener>();
    ...
    private Set<String> seedHostNameSet = new HashSet<String>();
    private int[] depthQueueCount;
    private Session session;
    private Model model;
    private boolean isStop = false;
    private Set<String> visitedGetMethod = new TreeSet<String>();
//    private Set queuedGetMethod = new TreeSet();
    private List<QueueItem> visitedPostMethod = new ArrayList<QueueItem>();
...
//        boolean result = false;
    ...
    private boolean isVisitedGetMethod(HttpMessage msg) {
    	...
    	synchronized(visitedGetMethod) {
    		return visitedGetMethod.contains(uri);
    	}
    }
