...
abstract public class AbstractAppParamPlugin extends AbstractAppPlugin {
    ...
    private List<Variant<NameValuePair>> listVariant = new ArrayList<Variant<NameValuePair>>();
    
    private Variant<NameValuePair> variant;
    private NameValuePair originalPair;
