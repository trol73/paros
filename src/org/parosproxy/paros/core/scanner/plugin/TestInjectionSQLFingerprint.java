...
//		mResBodyNormal = msg.getResponseBody().toString();
		...
		String newQuery = setParameter(msg, param, value+SQL_CHECK_ERR);
		long lastTime = System.currentTimeMillis();
		sendAndReceive(msg);
		long defaultTimeUsed = System.currentTimeMillis() - lastTime;
//		mResBodyError	= msg.getResponseBody().toString();
	...
	private void testMSBlindINSERT(HttpMessage msg, String param, String value) throws HttpException, IOException {
		...
		for (int i=0; i<TRY_COUNT; i++) {
			...
			// try INSERT
			String newQuery = setParameter(msg, param, value + "'" + sbInsertValue.toString() + SQL_BLIND_MS_INSERT);
