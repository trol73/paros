...
abstract public class AbstractPlugin implements Plugin, Comparable<AbstractPlugin> {
...
//		msg.setResponseBody(temp.getResponseBody());
     ...
     */
    public int compareTo(AbstractPlugin test) {
    	if ( getId() < test.getId() ) {
    		return -1;
    ...
    public boolean equals(AbstractPlugin obj) {
