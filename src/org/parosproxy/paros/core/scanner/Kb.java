...
public class Kb {
    ...
    // KB related
    private Map<String, Object> mapKb = new TreeMap<String, Object>();
    private Map<String, Object> mapURI = new TreeMap<String, Object>();
	 ...
	 */
	public synchronized List<Object> getList(String key) {
	...
	public synchronized List getList(URI uri, String key) {
	    uri = (URI) uri.clone();
	    String uriKey = uri.toString();
	    TreeMap map = null;
	    try {
	 ...
	 * @param value
	 */
	private void add(Map map, String key, Object value) {
	    List v = getList(map, key);
	    if (v == null) {
	        v = new ArrayList();
	        synchronized (map) {
	            map.put(key, v);
	 ...
	 * @param value
	 */
	private List<Object> getList(Map map, String key) {
		List result = null;
	    Object obj = null;
	    synchronized (map) {
	        obj = map.get(key);
