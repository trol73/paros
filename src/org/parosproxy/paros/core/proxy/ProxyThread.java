...
//	private static ArrayList 		processForwardList = new ArrayList();
	...
	protected HttpInputStream httpIn;
	protected HttpOutputStream httpOut;
	protected ProxyThread originProcess;
...
//	private Thread forwardThread = null;
    ...
    private static List<Thread> proxyThreadList = new Vector<Thread>();
...
//	}
	...
	private void notifyListenerRequestSend(HttpMessage httpMessage) {
		for ( ProxyListener listener : parentServer.getListenerList() ) {
			try {
